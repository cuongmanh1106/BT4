                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        @foreach (['danger', 'warning', 'success', 'info'] as $msg)
                            ...
                            <div class="alert alert-{{ $msg }}">{{ Session::get('alert-'.$msg) }}<button class="close" data-dismiss="alert" aria-label="close">&times;</button></div>
                        ...
                        <div class="panel-body">
                            <div class=" form">
                                ...
                                @endif
                                <form method="POST" class="cmxform form-horizontal " id="commentForm"  action="{{ route('categories.store')}}" novalidate="novalidate">
                                    {{ csrf_field() }}
