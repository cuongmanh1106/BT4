...
<div class="w3layouts-main">
	...
	@endif
		...
		<p>Don't Have an Account ?<a href="{{ route('register.get') }}">Create an account</a></p>
</div>
</div>
...
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="public/js/flot-chart/excanvas.min.js"></script><![endif]-->
