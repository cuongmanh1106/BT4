...
<script src="{{ asset('/public/js/kiemtra.js') }}"></script>
<script src="{{ asset('/public/js/plugin/ckeditor/ckeditor.js') }}"></script>
<script src="{{ asset('/public/js/plugin/ckfinder/ckfinder.js') }}"></script>
<style type="text/css">
