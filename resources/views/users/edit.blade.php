                            ...
                            <div class=" form">
                               @if (count($errors) > 0)
                                ...
                                @foreach (['danger', 'warning', 'success', 'info'] as $msg)
                                    ...
                                    @endif
                                @endforeach
                                <form method="POST" enctype="multipart/form-data" class="cmxform form-horizontal " id="commentForm" method="get" action="{{ route('users.update',$user['id'])}}" novalidate="novalidate">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="email" minlength="2" type="email" required=""  value = "{{ $user['email'] }}">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <select class="form-control input-lg m-bot15" name="level">
                                                ...
                                                <option value="2" {{ ($user['level'] == 2)?'selected':'' }} >SuperAdmin</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control " name="password" id="password" type="password" name="password" value="{{ $user['password'] }}">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="curl" class="control-label col-lg-3">Password Confirm </label>
                                        <div class="col-lg-6">
                                            <input class="form-control " name="password_confirm" id="password_confirm" type="password" name="password" value="{{ $user['password'] }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <button class="btn btn-primary" onclick="return check_password()" type="submit">Save</button>
